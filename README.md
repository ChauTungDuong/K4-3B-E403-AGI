...
**Lớp:** 3B · **Phòng:** E403 · **Cụm:** C6 · **Track:** Track B — Trợ lý Học viên Discord

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Châu Tùng Dương | 2A202602822 | Product Lead (Đội trưởng) | Canvas CP1, spec.md, nộp form checkpoint |
| Nguyễn Đình Tuấn Anh | 2A202602735 | Data & Evidence | Thu thập bằng chứng, khai thác log k4_messages.csv, willing users |
| Đỗ Mạnh Nghĩa | 2A202602971 | AI & Evaluation | 4 lớp chỗ khó, kịch bản lỗi, golden set trong eval/ |
| Nguyễn Ngọc Tuyền | 2A202603010 | UX & Prototype | Thiết kế giao diện tóm tắt P1/P2/P3, codebase prototype |
